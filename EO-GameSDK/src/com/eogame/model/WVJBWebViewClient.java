...
public class WVJBWebViewClient extends WebViewClient {
	//常量
	public static String APP_ID = "gameCode";
	...
	public static String AUTOLOGINSTATE = "autoLoginState";
	public static String FLOATBUTTONSTATE = "floatButtonState";
	public static String SDKVERSION = "sdkVersion";
	public static String ENABLECUSTOMERSERVICE = "enableCustomerService";
	//
